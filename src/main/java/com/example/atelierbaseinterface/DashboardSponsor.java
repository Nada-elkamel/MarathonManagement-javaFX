...
public class DashboardSponsor implements Initializable {
    ...
    public void addSponsor(ActionEvent actionEvent) {
        ...
        try {
            ...
            alert.setContentText("Impossible d'insérer le coureur");
            alert.showAndWait();
            e.printStackTrace();
        }
    }
    ...
    public void updateSponsor(ActionEvent actionEvent) {
        ...
        try {
            ...
            alert.setContentText("Impossible de mettre à jour le sponsor");
            alert.showAndWait();
            e.printStackTrace();
        }
    }
    ...
    public void deleteSponsor(ActionEvent actionEvent) {
        ...
        if (selectedSponsor == null) {
            ...
            errorAlert.setContentText("Aucun sponsor sélectionné.");
        ...
        confirmationAlert.setContentText("Voulez-vous vraiment supprimer ce sponsor ?");
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            try {
                ...
                if (rowsDeleted > 0) {
                    ...
                    successAlert.setContentText("Le sponsor a été supprimé avec succès.");
                    ...
                    Alert errorAlert = new Alert(Alert.AlertType.ERROR);
                    errorAlert.setTitle("Erreur");
                    errorAlert.setContentText("Impossible de supprimer le sponsor.");
                    errorAlert.showAndWait();
                }
            } catch (SQLException e) {
                Alert errorAlert = new Alert(Alert.AlertType.ERROR);
                errorAlert.setTitle("Erreur");
                errorAlert.setContentText("Une erreur s'est produite lors de la suppression du sponsor.");
                errorAlert.showAndWait();
                e.printStackTrace();
            }
        }

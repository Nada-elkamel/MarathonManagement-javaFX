...
public class DashboardMarathon implements Initializable {
    ...
    public void addMarathon(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (ligneInsere > 0) {
                ...
                alert.setContentText("Erreur lors de l'insertion");
                alert.showAndWait();
            }
            ps.close();
            ...
            alert.setContentText("Impossible d'insérer le marathon");
            alert.showAndWait();
            e.printStackTrace();
        }
    }
    ...
    public void updateMarathon(ActionEvent actionEvent) {
        ...
        try {
            ...
            alert.setContentText("Impossible de mettre à jour le marathon");
            alert.showAndWait();
            e.printStackTrace();
        }
    }
    ...
    public void deleteMarathon(ActionEvent actionEvent) {
        ...
        if (selectedMarathon == null) {
            ...
            errorAlert.setContentText("Aucun marathon sélectionné.");
        ...
        confirmationAlert.setContentText("Voulez-vous vraiment supprimer ce marathon ?");
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            try {
                ...
                if (rowsDeleted > 0) {
                    ...
                    successAlert.setContentText("Le marathon a été supprimé avec succès.");
                    ...
                    Alert errorAlert = new Alert(Alert.AlertType.ERROR);
                    errorAlert.setTitle("Erreur");
                    errorAlert.setContentText("Impossible de supprimer le marathon.");
                    errorAlert.showAndWait();
                }
            } catch (SQLException e) {
                Alert errorAlert = new Alert(Alert.AlertType.ERROR);
                errorAlert.setTitle("Erreur");
                errorAlert.setContentText("Une erreur s'est produite lors de la suppression du marathon.");
                errorAlert.showAndWait();
                e.printStackTrace();
            }
        }
